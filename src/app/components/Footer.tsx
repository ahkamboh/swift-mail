    ...
    return (
        <footer className='footer-background'>
            <div className="container mx-auto w-full sm:px-16 px-8  sm:pt-10 pt-5 space-y-4 sm:block flex flex-col justify-center items-center ">
                <div className="sm:w-fit w-[90px] ClashDisplay-Bold sm:text-4xl tracking-widest">
                    <h1>SwiftMail</h1>
		...
		<div className=" w-full sm:text-start  text-center text-white text-base font-normal leading-snug">@ 2024 Swift Mail. All rights reserved.</div>
...
<a href="https://linkedin.com/company/EmailGenie" target="_blank" className=" relative">
